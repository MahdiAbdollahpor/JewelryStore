...
{
    /// <inheritdoc />
    public partial class AddVariantRelationships : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExcludedProducts = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "شناسه یکتا")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Username = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false, comment: "شماره تماس باید با 09 شروع و 11 رقم باشد"),
                    PasswordHash = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, comment: "رمز عبور هش شده (هرگز به صورت ساده ذخیره نمی‌شود)"),
                    FullName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true, comment: "نام و نام خانوادگی - اختیاری"),
                    Role = table.Column<int>(type: "int", nullable: false, defaultValue: 0, comment: "نقش کاربر: 0 = User, 1 = Admin"),
                    IsPhoneVerified = table.Column<bool>(type: "bit", nullable: false, defaultValue: false, comment: "آیا شماره تماس تایید شده است؟"),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true, comment: "آیا حساب کاربری فعال است؟"),
                    Address = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true, comment: "آدرس - در زمان سفارش اجباری می‌شود"),
                    LastLoginAt = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "تاریخ آخرین ورود"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()", comment: "تاریخ ایجاد"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "تاریخ آخرین ویرایش")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoldPriceReference = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CraftsmanshipFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    StoneType = table.Column<int>(type: "int", nullable: true),
                    StoneWeight = table.Column<decimal>(type: "decimal(10,3)", precision: 10, scale: 3, nullable: true),
                    StoneQuality = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountCodeAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
                    ShippingAddress = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    RecipientName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    RecipientPhone = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShippingSettings_Users_UpdatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaxSettings_Users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalSchema: "dbo",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantAttributes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountUsages_DiscountCodeId_UserId_OrderId",
                table: "DiscountUsages",
                columns: new[] { "DiscountCodeId", "UserId", "OrderId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingSettings_UpdatedByUserId",
                table: "ShippingSettings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaxSettings_IsActive",
                table: "TaxSettings",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_TaxSettings_UpdatedByUserId",
                table: "TaxSettings",
                column: "UpdatedByUserId");
